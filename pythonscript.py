...
def Top10Domain(FileName):
	...
	for line in access_file:
		#"try" this statements
			...
			#just pass or skip
        		pass
	#initialise the counter to count the number of occurences of the same data
	counter = collections.Counter(log_array)
	
	#this will return a list of most commont elements and their accounts from hights to lowest
	#(10) can be change to any value

	new_file = open("scriptresults.txt",'a')
